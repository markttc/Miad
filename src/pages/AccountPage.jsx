      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <div className="card text-center">
            ...
            <div className="text-sm text-white">Upcoming Sessions</div>
          </div>
          <div className="card text-center">
            ...
            <div className="text-sm text-white">E-Learning Courses</div>
          </div>
          <div className="card text-center">
              ...
              <div className="space-y-4">
                {upcomingBookings.length === 0 ? (
                  <div className="card text-center py-12">
                    ...
                    <p className="text-white mb-4">No upcoming sessions</p>
              ...
              <div className="space-y-4">
                {elearningBookings.length === 0 ? (
                  <div className="card text-center py-12">
                    ...
                    <p className="text-white mb-4">No e-learning courses purchased</p>
        ...
        <details className="mt-4 pt-4 border-t border-gray-700">
          ...
          <div className="mt-3 p-4 bg-gray-900 rounded-lg text-sm space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-white">Meeting ID:</span>
            ...
            <div className="flex items-center justify-between">
              <span className="text-white">Join Link:</span>
              <a
                href={booking.zoomMeeting.joinUrl}
                target="_blank"
                rel="noopener noreferrer"
