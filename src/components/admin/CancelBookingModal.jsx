    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-gray-800 rounded-xl border border-gray-700 p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white">{booking.bookingRef}</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="bg-gray-900/50 rounded-lg p-4 mb-6">
          <h3 className="text-sm font-medium text-white mb-3">Booking Summary</h3>
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-white">({booking.attendee?.email})</span>
            </div>
            <div className="flex items-center gap-2 text-sm">
            ...
            <div className="pl-7">
              ...
              {isPartialRefund && (
                <div className="mt-3 flex items-center gap-2">
                  ...
                  />
                  <span className="text-sm text-white">of £{fullAmount}</span>
                </div>
              )}
            </div>
          )}
